...
function addDriveSalary(params,callback){
    var query = " insert into drive_salary ( " +
        ...
        " damage_under_fee, accident_fee, peccancy_under_fee, exceed_oil_fee, damage_retain_fee, damage_op_fee, truck_retain_fee, personal_tax, hotel_bonus, full_work_bonus, transfer_bonus , other_bonus," +
    ...
    paramsArray[i++]=params.transferBonus;
...
function getDriveSalary(params,callback) {
    var query = " select ds.id,ds.month_date_id,ds.truck_id,ds.company_id,ds.user_id,ds.load_distance,ds.no_load_distance,ds.salary_ratio," +
        ...
        "           ds.exceed_oil_fee,ds.damage_retain_fee,ds.damage_op_fee,ds.truck_retain_fee,ds.personal_tax,ds.hotel_bonus,ds.full_work_bonus, ds.transfer_bonus ,ds.other_bonus," +
        "           ds.car_oil_fee,ds.truck_parking_fee,ds.car_parking_fee,ds.lead_fee,ds.run_fee,ds.car_pick_fee,ds.trailer_fee,ds.clean_fee,ds.dp_other_fee," +
        "           ds.social_security_fee,ds.food_fee,ds.loan_fee,ds.other_fee,ds.actual_salary,ds.remark,ds.grant_status,ds.salary_ratio" +
        ...
        "               when drt.reverse_flag=0 and drt.truck_number=8 and drt.car_count>=9 and drt.distance<500 then drt.distance*1.4 " +
        "               when drt.reverse_flag=0 and drt.truck_number=8 and drt.car_count>=9 and drt.distance>=500 and drt.distance<1000  then drt.distance*1.3 " +
        "               when drt.reverse_flag=0 and drt.truck_number=8 and drt.car_count>=9 and drt.distance>=1000 then drt.distance*1.2 " +
        "               end) distance_salary, " +
...
function getDriveSalaryBase(params,callback) {
    var query = " select ds.*,ds.salary_ratio * ds.distance_salary AS distance_salary_ratio ,d.drive_name,t.id as truck_id,t.truck_num,t.brand_id as truck_brand_id ,tb.brand_name,t.operate_type,c.company_name,ui.mobile,d.level " +
