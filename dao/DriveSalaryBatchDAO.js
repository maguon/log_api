...
function updateDistanceSalary(params, callback) {
    var query = "UPDATE drive_salary as ds" +
        ...
        "      WHEN reverse_flag=0 and truck_number=8 and car_count<4 then distance*0.3" +
        "      WHEN reverse_flag=0 and truck_number=8 and car_count=4 then distance*0.6" +
