...
function addDpRouteLoadTask(params,callback){
    var query = " insert into dp_route_load_task (user_id,load_task_type,demand_id,transfer_demand_id,dp_route_task_id,route_id,route_start_id,base_addr_id,route_end_id,receive_id,date_id," +
        "plan_date,plan_count,transfer_flag,transfer_city_id,transfer_addr_id) values ( ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ? ) ";
    var paramsArray=[],i=0;
