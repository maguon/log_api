...
function getDpRouteLoadTask(params,callback) {
    var query = " select dprl.*,dprl.route_start as city_start_name,dprl.route_end as city_name,dprl.transfer_city as transfer_city_name, " +
        ...
        " r.make_name,r.clean_fee,r.big_clean_fee,r.trailer_fee,r.trailer_month_flag,r.run_fee,r.run_month_flag,r.lead_fee,r.lead_month_flag,r.other_fee," +
        " r.other_month_flag,r.receive_flag,r.month_flag, " +
