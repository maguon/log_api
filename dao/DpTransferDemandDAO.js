...
function addDpTransferDemand(params,callback){
    var query = " insert into dp_demand_info (user_id,demand_id,route_start_id,base_addr_id,transfer_city_id,transfer_addr_id,route_end_id, " +
...
function getDpTransferDemand(params,callback) {
    var query = " select dptd.*,c1.city_name as route_start_name,c2.city_name as route_end_name,r.short_name" +
