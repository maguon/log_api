...
function getDpTaskTransferStat(params,callback) {
    var query = " select sum(dptts.transfer_count) as transfer_count,sum(dptts.plan_count) as plan_count, " +
        ...
        " left join city_info c2 on dptts.route_start_id = c2.id " +
    ...
    query = query + ' group by dptts.route_start_id,dptts.transfer_city_id,c.city_name,dptts.route_end_id,c1.city_name,dptts.date_id ';
