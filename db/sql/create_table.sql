...
CREATE TABLE `drive_info` (
  ...
  `ascription_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '所属类型（1-自营,2-承包,3-供方,4-外协）',
  `drive_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '司机所属类型（1-板车司机,2-短驳司机）',
  `drive_status` tinyint(1) DEFAULT '1' COMMENT '司机状态(0-在途,1-待运,2-休息)',
...
CREATE TABLE `truck_info` (
  ...
  `operate_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '运营类型（1-自营,2-承包,3-供方,4-外协）',
  `truck_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '车辆类型（1-车头,2-挂车）',
  `truck_status` tinyint(1) DEFAULT '0' COMMENT '当前状态(0-可用,1-使用中,2-维修中,3-报废)',
...
-- ----------------------------
-- Table structure for truck_relevance
-- ----------------------------
DROP TABLE IF EXISTS `truck_relevance`;
CREATE TABLE `truck_relevance` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '唯一自增ID',
  `front_id` int(10) DEFAULT NULL COMMENT '车头ID',
  `trailer_id` int(10) DEFAULT NULL COMMENT '挂车ID',
  PRIMARY KEY (`id`)
