...
CREATE TABLE `drive_refuel` (
  ...
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '司机ID',
  ...
  `refule_address` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '加油详细地址',
  ...
  `check_status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '审核状态(1-通过,2-拒绝)',
